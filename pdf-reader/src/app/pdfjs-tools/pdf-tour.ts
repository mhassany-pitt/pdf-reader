...
const TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    body: 'Highlight, underline, or strike through document text. Click an existing markup to add notes or change colors.',
    selectors: ['.pdf-toolbar__highlight-btn', '.pdf-toolbar__underline-btn', '.pdf-toolbar__strikethrough-btn'],
  },
  {
    id: 'notes-text',
    title: 'Notes & text boxes',
    body: 'Click the page to drop a sticky note or place visible free-text annotations on the document.',
    selectors: ['.pdf-toolbar__note-btn', '.pdf-toolbar__text-btn'],
  },
  {
    id: 'draw-embed',
    title: 'Draw & embed tools',
    body: 'Sketch freehand with the pen tool, or embed external links, videos, and interactive frames.',
    selectors: ['.pdf-toolbar__freeform-btn', '.pdf-toolbar__embed-btn'],
  },
  {
    id: 'delete',
    title: 'Delete annotations',
    body: 'Enter delete mode and click an annotation to remove it, or select one and press Delete or Backspace.',
