    ...
    return `
      <div class="pdf-annotation__embed-editor-popup-controls"> 
        ...
        <div class="pdf-annotation__embed-editor-popup-target-size-row" 
          ...
          `<div class="pdf-annotation__embed-editor-popup-on-hover-row" style="margin-bottom: 0.25rem">
            ...
            <label for="${tmpid}-on-hover" style="text-decoration: underline">Open on hover</label>
          </div>` : ''}
        </div>`: ''}
        ${configs?.newPage ?
